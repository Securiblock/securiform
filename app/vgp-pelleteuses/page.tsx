      ...
      <div className="container">
        ...
        <div className="faq reveal">
          ...
          <details className="faq-item">
            ...
            <p>Oui, la conduite d'une pelleteuse relève du CACES R482B (catégorie B1), complémentaire à la VGP&nbsp;: la VGP contrôle l'état de l'équipement, le CACES certifie la compétence du conducteur.</p>
          </details>
      ...
      <div className="container">
        <div className="vgp reveal">
          <div>
            ...
            <p>La VGP contrôle l'état de vos pelleteuses&nbsp;; le CACES R482B certifie la compétence de vos conducteurs. Les deux sont complémentaires et souvent nécessaires ensemble.</p>
