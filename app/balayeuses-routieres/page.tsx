...
export const metadata: Metadata = {
  ...
  description: "Formation SECURIFORM à la conduite des balayeuses routières : angles morts, signalisation et vérifications avant utilisation, dans la moitié nord de la France.",
